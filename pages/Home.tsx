  ...
  return (
    <div className="fade-in bg-soft-glow">
            ...
            <div className="lg:col-span-7 text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-100 shadow-sm mb-8">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
                  Available for Remote / Hybrid EU
                </span>
              </div>
              ...
              <p className="text-lg md:text-xl text-slate-400 max-w-xl mx-auto lg:mx-0 mb-10 leading-relaxed font-medium">
                Turning enterprise data into actionable insights through SQL,
                Python, and Machine Learning.{" "}
                <span className="text-slate-900">
                  I provide data-driven solutions.
                </span>
              </p>
      ...
      <Section
        ...
        subtitle="Bridging the gap between code and clarity."
      >
        <div className="max-w-3xl mx-auto">
          <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-medium">
            <p>
              My path into data wasn't just about learning SQL or Python—it was
              about a deep-seated curiosity for how{" "}
              <strong>complex systems</strong> operate. Starting as a Computer
              Science student, I quickly realized that while building software
              is powerful, the real "magic" happens when you can make that
              software <em>speak</em> through its data.
            </p>
            <p>
              I specialize in simplifying the noise. Whether it's optimizing
              queries or building predictive models, my goal is always to deliver
              actionable strategy. I translate technical complexity into
              business growth.
            </p>
            <p>
              When I'm not digging into datasets, I'm exploring the latest in AI
              productivity and digital infrastructure. I believe every dataset
              tells a story, and I am here to ensure that story drives results
              for your business.
            </p>
          </div>
      ...
      <Section
        ...
        subtitle="Modern tools for high-performance enterprise analytics."
        dark
      >
